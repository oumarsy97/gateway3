...
import { sampleWithRequiredData } from '../produit-commande.test-samples';
...
describe('ProduitCommande Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ProduitCommandeComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.produitCommandes()[0]).toEqual(expect.objectContaining({ id: 1566 }));
  });

  describe('trackId', () => {
    it('Should forward to produitCommandeService', () => {
      const entity = { id: 1566 };
      jest.spyOn(service, 'getProduitCommandeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProduitCommandeIdentifier).toHaveBeenCalledWith(entity);
